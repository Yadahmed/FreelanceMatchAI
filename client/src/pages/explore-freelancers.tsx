...
export default function ExploreFreelancers() {
  ...
  // Change sort field
  const changeSortField = (field: 'rating' | 'hourlyRate') => {
    if (sortBy === field) {
      toggleSortOrder();
    } else {
      setSortBy(field);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Find the perfect talent for your projects from our community of skilled freelancers</p>
      </div>
