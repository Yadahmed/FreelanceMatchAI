    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col space-y-4">
        ...
        <Link href="/explore-freelancers">
          <Button variant="default" size="lg" className="w-full justify-start h-auto py-3 bg-primary text-white group">
            <Users className="mr-2 h-5 w-5 text-white" />
            <div className="text-left">
              <div className="font-medium">Browse Freelancers</div>
              <div className="text-xs text-white/80">Explore our directory of qualified Kurdish freelancers</div>
            </div>
          </Button>
        </Link>
        ...
        {isAuthenticated && isClient && (
          <Link href="/client-messages">
            <Button variant="outline" size="lg" className="w-full justify-start h-auto py-3 border-primary/20 bg-background hover:bg-accent group">
